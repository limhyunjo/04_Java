 ...
 * - Java프로그램 - 외부 프로그램 / 장치 연결을 끊을 때 주로 사용
 * 
 */
public void method2() {
  ...
  //-> 프로그램 수행 후 scan 이 메모리에 남아있어 
  // 메모리 누수 ( 쓸때 없는 메모리 차지) 발생 
  
  //[해결 방법]
  //Scanner를 close ( 메모리 반환 ) 하기 
  //-> 코드에서 예외가 발생하던 말던 무조건 close 수행 필수!!
  //--> finally 가 이 코드를 수행하는데 부합함!!
