...
0. 프로그램 종료
			...
			case 5: 
				...
				break;
			case 6: String result = compareJava(std1, std2);
	...
	private void updateJava(Student s) {
		...
		int before = s.getJava(); // 이전 점수를 따로 표시하기 위해 before instance 만듦
	...
	private String compareJava(Student s1, Student s2) {
		...
		String result =String.format("%s :%d/ %s : %d |n", 
