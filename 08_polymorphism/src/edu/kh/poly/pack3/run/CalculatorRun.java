...
import edu.kh.poly.pack3.model.dto.LHJCalculator;
import edu.kh.poly.pack3.model.dto.LHJCalcultor2;
...
public class CalculatorRun {
 ...
 public static void main(String[] args) {
	...
	// Calculator cal = new LHJCalculator();
	  Calculator cal = new LHJCalcultor2();
	  
	 System.out.println(cal.plus(1, 4));
	 System.out.println(cal.minus(8, 2));
	 System.out.println(cal.multi(3, 5));
	 System.out.println(cal.div(3, 2));
	 System.out.println(cal.mod(7, 2));
	 System.out.println("----------------------------------");
	 System.out.println("sum : " + cal.sum(1,2,3,4,5,6));
