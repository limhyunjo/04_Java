...
public class VariableEx1 {
 ...
 public static void main(String[] args) {
   ...
   */
	...
	// 값 대입 : 변수에 값 집어 넣는 것( 이미 값이 있는 변수에 대입하면 -> 덮어쓰기)
	isTrue = true;
	System.out.println("isTrue : " + isTrue); //isTrue : true
	
	isTrue = false;
    System.out.println("isTrue : " + isTrue); //isTrue : false
    
    //변수 선언 + 초기화 + 값의 범위 확인
    int number2 = 2100000000; //21억 오류 X,
    long number3 = 2200000000L;//22억은 int 값의 범위를 초과해서 오류 O,
    //int 범위 초과 -> int 보다 범위가 큰 자료형으로 변경
    //long  number3 = 2200000000L; 오류 해결
    
    // 'L' 같은 리터럴 표기법은 컴퓨터가 자료형 구분을 위한 기호일 뿐, 출력 시 안 보임
    // 리터럴 표기법 :변수를 선언함과 동시에 그 값을 지정해주는 표기법
    
    System.out.println(" number2 : "+ number2);//number2 : 2100000000
    System.out.println(" number3 : "+ number3);//number3 : 2200000000
